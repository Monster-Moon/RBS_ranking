...
readLines('..//soi//ED-00028-00000012.soi', n = 11)
apa_data = read.table('..//soi//ED-00028-00000012.soi', skip = 12)
...
save(data_list, file = 'r5_data_list.Rdata')

#### model fitting ####
setwd('/Users/moon/Documents/CBS_model/code/real_data/soc_code')
load('r5_data_list.Rdata')
source('../model.R')
...
save(model_list, file = 'r5_model_list.Rdata')
...
save(btm_model_list, file = 'r5_btm_list.Rdata')
...
save(bt_model_list, file = 'r5_bt_list.Rdata')
...
source('..//model.R')
load('r5_data_list.Rdata')
load('r5_model_list.Rdata')
load('r5_btm_list.Rdata')
load('r5_bt_list.Rdata')
...
r5_result = list(train = train, test = test, valid = valid)
save(r5_result, file = 'r5_result.Rdata')

...
readLines('..//soi//ED-00028-00000011.soi', n = 11)
apa_data = read.table('..//soi//ED-00028-00000011.soi', skip = 12)
...
save(data_list, file = 'r4_data_list.Rdata')

#### model fitting ####
setwd('/Users/moon/Documents/CBS_model/code/real_data/soc_code')
load('r4_data_list.Rdata')
source('../model.R')
...
save(model_list, file = 'r4_model_list.Rdata')
...
save(btm_model_list, file = 'r4_btm_list.Rdata')
...
save(bt_model_list, file = 'r4_bt_list.Rdata')
...
source('..//model.R')
load('r4_data_list.Rdata')
load('r4_model_list.Rdata')
load('r4_btm_list.Rdata')
load('r4_bt_list.Rdata')
...
r4_result = list(train = train, test = test, valid = valid)
save(r4_result, file = 'r4_result.Rdata')
